...
from model_128_strong_eegonly_train import EEGDiffusionModel128
...
def main():
    ...
    parser.add_argument("--ckpt_root", type=str, default="./checkpoints_subj128_group_strong_eegonly")
